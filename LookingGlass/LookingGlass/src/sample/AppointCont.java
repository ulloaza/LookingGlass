...
public class AppointCont {
	//Linking fxml objects to controller
	@FXML 
    ...
    //controllers for communication between multiples conts
    ...
    /*
     * @puropse - handles which time slot is selected
     */
    ...
    public void handleCreate(ActionEvent event) throws IOException {
    	...
    	//various String information for appt info
    ...
    /*
     * @purpose - if appointment is selected in view
     */
    ...
    /*
     * @purpose - if "todo" is selected in view
     */
    ...
    /*
     * @purpose - initialize main controller
     */
	...
	/*
	 * @purpose - initialize month controller
	 */
	...
	/*
	 * @purpose - setting the stage title
	 */
