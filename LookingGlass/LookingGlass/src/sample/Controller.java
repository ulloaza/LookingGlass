...
public class Controller implements Initializable{
	//fxml linking objects to controller
    @FXML
	...
	/*
	 * @purpose - close button event handler
	 */
    ...
    /*
     * @purpose - handles the month view button
     */
    ...
    /*
     * @purpose - task bar event handler for adding new user
     */
    ...
    /*
     * @purpose - taskbar handler for loading a new user
     */
    ...
    /*
     * @purpose - task bar handler for deleting an appt
     */
    public void deleteTask(ActionEvent event) {
    	handleMonthView(new ActionEvent());
    }
    /*
     * @purpose  - taskbar handler for pressing the info button
     */
    ...
    /*
     * @purpose handles the appt edits
     * @param - GregorianCalendar date, ListView<Serializable> listview
     */
    ...
    /*
     * @purpose handles the appointment delete function
     * @param GregorianCalendar date, ListView<Serializable> listview
     */
    ...
    /*
     * @purpose - handles the note edit function
     * @param - GregorianCalendar date, ListView<Serializable> listview
     */
    ...
    /*
     * @purpose - handles the note delete function
     * @param - GregorianCalendar date, ListView<Serializable> listview
     */
    ...
    /*
     * @purpose - loads the information to the main fxml view
     * @param GregorianCalendar date1, GregorianCalendar date2, GregorianCalendar date3
     */
    ...
    /*
     * @ purpose  giving date1, load all remaining weathers
     * @param - date
     */
    ...
    /*
     * @purpose - loads the curreent user name
     */
